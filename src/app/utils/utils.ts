...
export class Utils {
  public convertArrayIntoObjForTypeAhead(
    ...
    const obj = { typeAheadData: [] as any[] };
  ...
  public convertJSDateToYYYYMM(date: Date) {
    return DateTime.fromJSDate(date).toFormat('yyyyLL');
  }

  public convertYYYYMMToJSDate(date: string) {
    return DateTime.fromFormat(date, 'yyyyLL').toJSDate();
  }

  public convertYYYYMMToMMMMYYYY(date: string) {
    return DateTime.fromFormat(date, 'yyyyLL').toFormat('MMMM yyyy');
  }
