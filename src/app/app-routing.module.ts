...
export const routes: Routes = [
  ...
  { path: 'inventory/protected-area', loadComponent: () => import('./inventory/protected-area/protected-area.component').then(mod => mod.ProtectedAreaComponent), canActivate: [UserGuard] },
  { path: 'inventory/protected-area/:orcs', loadComponent: () => import('./inventory/protected-area/protected-area-details/protected-area-details.component').then(mod => mod.ProtectedAreaDetailsComponent), canActivate: [UserGuard],  resolve: { protectedArea: ProtectedAreasResolver } },
  { path: 'inventory/protected-area/:orcs/edit', loadComponent: () => import('./inventory/protected-area/protected-area-edit/protected-area-edit.component').then(mod => mod.ProtectedAreaEditComponent), canActivate: [UserGuard], resolve: { protectedArea: ProtectedAreasResolver } },
];
