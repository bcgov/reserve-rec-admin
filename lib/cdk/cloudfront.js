...
const CLOUDFRONT_CERTIFICATE_ARN = 'arn:aws:acm:us-east-1:970582042516:certificate/ef1d2666-8278-4d20-bdff-e27b55b3246f';
...
function cloudFrontSetup(scope, props) {
  ...
  for (const bucket of [props.reserveRecAdminDistBucket, props.reserveRecAdminLogBucket]) {
    bucket.addToResourcePolicy(new PolicyStatement({
      ...
      principals: [new iam.CanonicalUserPrincipal(reserveRecAdminDistribution.distributionId)],
    }));
  }
